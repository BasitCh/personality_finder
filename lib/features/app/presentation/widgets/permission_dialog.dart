...
class PermissionDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final message = permissionFor == 'storage'
        ? AppLocalizations.of(context)!.permission_storage_desc_text
        : permissionFor == 'location'
            ? AppLocalizations.of(context)!.permission_location_desc_text
            : permissionFor == 'Camera'
                ? AppLocalizations.of(context)!.permission_cammera_desc_text
                : AppLocalizations.of(context)!.permission_media_desc_text;
    return SimpleDialog(
