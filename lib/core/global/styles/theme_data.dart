...
// Project imports:
import '../theming/theme/base_theme.dart';
import '../util/environment/environment_util.dart';
import '../util/environment/os_info.dart';
...
class FlutterTemplateThemeData {
  ...
  static final _darkThemeData = ThemeData(
    ...
    colorScheme:
        ColorScheme.fromSwatch().copyWith(secondary: ThemeColors.accent),
  );
