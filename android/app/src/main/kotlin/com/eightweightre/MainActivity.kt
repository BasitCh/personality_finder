...
import com.eightweightre.template.bridge.LoggerPlugin
...
class MainActivity : FlutterActivity() {
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "eightweightre.com/template").setMethodCallHandler { call, result ->
