...
// in morphosis_template/test/core/global/util/auth/cache/cache_controller_test.dart.
...
class _FakeCacheStore_0 extends _i1.SmartFake implements _i2.CacheStore {
  _FakeCacheStore_0(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}

class _FakeWebHelper_1 extends _i1.SmartFake implements _i3.WebHelper {
  _FakeWebHelper_1(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class _FakeFileInfo_3 extends _i1.SmartFake implements _i5.FileInfo {
  _FakeFileInfo_3(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class MockDefaultCacheManager extends _i1.Mock
  ...
  _i2.CacheStore get store => (super.noSuchMethod(Invocation.getter(#store),
          returnValue: _FakeCacheStore_0(this, Invocation.getter(#store)))
      as _i2.CacheStore);
  @override
  _i3.WebHelper get webHelper => (super.noSuchMethod(
          Invocation.getter(#webHelper),
          returnValue: _FakeWebHelper_1(this, Invocation.getter(#webHelper)))
      as _i3.WebHelper);
  @override
  _i7.Future<_i4.File> getSingleFile(String? url,
      ...
      (super.noSuchMethod(
              ...
              returnValue: _i7.Future<_i4.File>.value(_FakeFile_2(this,
                  Invocation.method(#getSingleFile, [url], {#key: key, #headers: headers}))))
  ...
  _i7.Stream<_i5.FileInfo> getFile(String? url,
      ...
      (super.noSuchMethod(
          ...
          returnValue:
              _i7.Stream<_i5.FileInfo>.empty()) as _i7.Stream<_i5.FileInfo>);
  @override
  _i7.Stream<_i5.FileResponse> getFileStream(String? url,
          {String? key,
      ...
      (super.noSuchMethod(
              ...
              returnValue: _i7.Stream<_i5.FileResponse>.empty())
          as _i7.Stream<_i5.FileResponse>);
  @override
  _i7.Future<_i5.FileInfo> downloadFile(String? url,
          ...
          bool? force = false}) =>
      (super
          .noSuchMethod(Invocation.method(#downloadFile, [url], {#key: key, #authHeaders: authHeaders, #force: force}),
  ...
  _i7.Future<_i5.FileInfo?> getFileFromMemory(String? key) =>
      (super.noSuchMethod(Invocation.method(#getFileFromMemory, [key]),
          ...
          as _i7.Future<_i5.FileInfo?>);
  @override
  _i7.Future<_i4.File> putFile(String? url, _i8.Uint8List? fileBytes,
          {String? key,
          String? eTag,
          Duration? maxAge = const Duration(days: 30),
          String? fileExtension = r'file'}) =>
      (super.noSuchMethod(Invocation.method(#putFile, [url, fileBytes], {#key: key, #eTag: eTag, #maxAge: maxAge, #fileExtension: fileExtension}),
  ...
  _i7.Future<_i4.File> putFileStream(String? url, _i7.Stream<List<int>>? source,
          ...
          Duration? maxAge = const Duration(days: 30),
          String? fileExtension = r'file'}) =>
      (super.noSuchMethod(Invocation.method(#putFileStream, [url, source], {#key: key, #eTag: eTag, #maxAge: maxAge, #fileExtension: fileExtension}),
          returnValue: _i7.Future<_i4.File>.value(_FakeFile_2(
              this,
  ...
  _i7.Future<void> dispose() => (super.noSuchMethod(
      ...
      returnValueForMissingStub: _i7.Future<void>.value()) as _i7.Future<void>);
  @override
  _i7.Stream<_i5.FileResponse> getImageFile(String? url,
          {String? key,
          Map<String, String>? headers,
          bool? withProgress = false,
          int? maxHeight,
